...
export function HelpModal({ onClose }: HelpModalProps) {
  return (
    ...
    >
      <div 
        className="bg-dicom-dark rounded-xl max-w-2xl w-full mx-4 max-h-[80vh] overflow-hidden"
      ...
      >
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(80vh-80px)]">
          ...
          <section className="mb-8">
            <h3 className="text-lg font-semibold text-dicom-accent mb-4">Keyboard Shortcuts</h3>
          ...
          {/* Mouse Controls */}
          <section className="mb-8">
            <h3 className="text-lg font-semibold text-dicom-accent mb-4">Mouse Controls</h3>
          ...
          {/* Loading Images */}
          <section className="mb-8">
            <h3 className="text-lg font-semibold text-dicom-accent mb-4">Loading Images</h3>
            <div className="space-y-3 text-gray-300">
          ...
          <section className="mb-8">
            <h3 className="text-lg font-semibold text-dicom-accent mb-4">Opening Medical CDs</h3>
            <div className="space-y-3 text-gray-300">
              ...
              <p className="mt-4"><strong className="text-white">Direct method:</strong></p>
              <ol className="list-decimal list-inside space-y-2 ml-4">
                <li>Insert the CD</li>
          ...
          {/* Privacy Notice */}
          <section className="bg-green-900/20 border border-green-800/30 rounded-lg p-4">
            <h3 className="text-lg font-semibold text-green-400 mb-2">Privacy & Security</h3>
...
function ShortcutItem({ shortcut, description }: { shortcut: string; description: string }) {
  return (
    <div className="flex items-center gap-3">
      <kbd className="px-2 py-1 bg-gray-800 text-gray-300 rounded text-sm font-mono min-w-[2.5rem] text-center">
        {shortcut}
      </kbd>
